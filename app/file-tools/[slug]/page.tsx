...
export const metadata = {
  title: "File Utilities | Dockitt",
  description: "Browser-based file utility tools. Coming soon.",
};

export default function FileToolSlugPage() {
  return (
    <main style={{ background: "#f9fafb", minHeight: "60vh" }}>
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "16px", color: "#6b7280", marginBottom: "32px", lineHeight: 1.6 }}>
          This file utility tool is coming soon. In the meantime, try our PDF tools below.
        </p>
