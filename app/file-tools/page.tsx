...
export const metadata = {
  title: "File Utilities Online | Dockitt",
  description: "Free browser-based file utility tools. Coming soon.",
};
    ...
    <main style={{ background: "#f9fafb", minHeight: "60vh" }}>
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "16px", color: "#6b7280", marginBottom: "32px", lineHeight: 1.6 }}>
          Browser-based file utility tools are on the way. Compress, archive, convert and inspect files — no upload, no account.
        </p>
