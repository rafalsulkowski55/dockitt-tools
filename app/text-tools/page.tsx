...
export const metadata = {
  title: "Text & Data Tools Online | Dockitt",
  description: "Free browser-based text and data tools. Coming soon.",
};
    ...
    <main style={{ background: "#f9fafb", minHeight: "60vh" }}>
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "16px", color: "#6b7280", marginBottom: "32px", lineHeight: 1.6 }}>
          Browser-based text and data tools are on the way. Transform, encode, format and analyse text and structured data — no upload, no account.
        </p>
