...
export default function JsonToCsvTool({ tool }: { tool: TextTool }) {
  ...
  async function handleConvert() {
    if (!input.trim()) { setErrorMessage("Please enter JSON data."); setStatus("error"); return; }
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
      <div>
        ...
        <textarea value={input} onChange={(e) => setInput(e.target.value)}
          placeholder={'[{"name":"Alice","age":30},{"name":"Bob","age":25}]'} style={taStyle} />
      </div>
