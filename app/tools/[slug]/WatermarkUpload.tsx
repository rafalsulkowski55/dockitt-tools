    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      {file && (
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          <label style={{ fontSize: "14px", color: "#444" }}>Watermark text:</label>
          <input
            type="text"
            value={text}
            ...
            style={{
              ...
              borderRadius: "8px", fontSize: "14px", width: "280px",
            }}
          />
        </div>
      )}
      ...
      <button
        ...
        style={{
          padding: "12px 18px",
          background: file && text.trim() && status !== "processing" ? "#2563eb" : "#d1d5db",
          color: "#ffffff", border: "none", borderRadius: "10px",
          fontWeight: 600,
          cursor: file && text.trim() && status !== "processing" ? "pointer" : "not-allowed",
          width: "fit-content",
        }}
      >
      ...
      {status === "done" && (
        <div style={{
          ...
          Done. Your watermarked PDF has been downloaded.
        </div>
      )}
