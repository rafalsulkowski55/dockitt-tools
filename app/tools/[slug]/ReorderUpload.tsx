  ...
  return (
    <>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        {status === "done" && <div style={{ padding: "14px 16px", background: "#eff6ff", color: "#2563eb", border: "1px solid #bfdbfe", borderRadius: "10px", fontSize: "14px" }}>✅ Pages reordered and PDF downloaded successfully.</div>}
      </div>
    </>
  );
}