...
export default function SplitUpload() {
  ...
  async function handleDownload() {
    ...
    a.href = downloadUrl;
    a.download = `split-${file?.name ?? "output.pdf"}`;
    a.click();
  }
  ...
  return (
    <>
      ...
      >
        ...
        <label htmlFor="split-upload" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", padding: "10px 20px", background: "#2563eb", color: "#ffffff", borderRadius: "10px", fontWeight: 600, cursor: "pointer", fontSize: "14px" }} onClick={(e) => e.stopPropagation()}>
          Choose PDF
        </label>
