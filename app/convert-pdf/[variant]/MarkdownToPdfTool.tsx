...
export default function MarkdownToPdfTool({ variant }: Props) {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      // Parse markdown → HTML → strip tags to get plain text
      const htmlResult = marked.parse(rawMd);
      ...
      for (let idx = 0; idx < total; idx++) {
        ...
        y -= LINE_H;
        lineOnPage++;
        setProgress(10 + Math.round((idx / total) * 85));
      }
  ...
  return (
    <>
      <input ref={inputRef} type="file" accept=".md" style={{ display: "none" }} onChange={handleFileChange} />
        ...
        <div onDrop={handleDrop} onDragOver={(e) => e.preventDefault()}
          ...
          {file ? (
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              <div style={{ width: "40px", height: "52px", borderRadius: "6px", background: "#eff6ff", border: "1px solid #bfdbfe", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontSize: "10px", fontWeight: 700, color: "#2563eb", textTransform: "uppercase" }}>MD</div>
            ...
            <div style={{ textAlign: "center", padding: "8px 0" }}>
              <div style={{ fontSize: "13px", color: "#666", marginBottom: "10px" }}>Drag & drop your Markdown file here or</div>
        ...
        {isProcessing && (
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: "12px", color: "#6b7280" }}>
              <span>Laying out pages...</span><span>{Math.round(progress)}%</span>
            </div>
