...
export default function PdfToTxtTool({ variant }: Props) {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      for (let i = 1; i <= pdf.numPages; i++) {
        ...
        // Extract text items, preserving end-of-line markers
  ...
  function handleDownload() {
    ...
    const a = document.createElement("a"); a.href = downloadUrl; a.download = `${baseName}.txt`; a.click();
  }
        ...
        {status === "done" && downloadUrl && (
          <div style={{ border: "1px solid #bfdbfe", borderRadius: "12px", overflow: "hidden" }}>
            <div style={{ background: "#eff6ff", padding: "12px 16px" }}>
              <p style={{ fontSize: "15px", fontWeight: 700, color: "#2563eb", margin: "0 0 2px" }}>✅ Text extracted</p>
              <p style={{ fontSize: "12px", color: "#16a34a", margin: 0 }}>Your text file is ready to download</p>
            </div>
