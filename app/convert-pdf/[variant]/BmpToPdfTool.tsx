...
// pdf-lib does not support BMP natively. Convert via canvas → PNG first.
...
export default function BmpToPdfTool({ variant }: Props) {
  ...
  return (
    <>
      <input ref={inputRef} type="file" accept=".bmp" multiple style={{ display: "none" }} onChange={handleFileChange} />
        ...
        <div onDrop={handleDrop} onDragOver={(e) => e.preventDefault()}
          ...
          {files.length > 0 ? (
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              <div style={{ width: "40px", height: "52px", borderRadius: "6px", background: "#eff6ff", border: "1px solid #bfdbfe", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontSize: "10px", fontWeight: 700, color: "#2563eb", textTransform: "uppercase" }}>BMP</div>
            ...
            <div style={{ textAlign: "center", padding: "8px 0" }}>
              <div style={{ fontSize: "13px", color: "#666", marginBottom: "10px" }}>Drag & drop your BMP files here or</div>
