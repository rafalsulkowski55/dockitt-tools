...
export const metadata = {
  title: "Image Editor Online | Dockitt",
  description: "Free browser-based image editing tools. Coming soon.",
};
    ...
    <main style={{ background: "#f9fafb", minHeight: "60vh" }}>
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "16px", color: "#6b7280", marginBottom: "32px", lineHeight: 1.6 }}>
          Browser-based image editing tools are on the way. Resize, crop, compress and convert images — no upload, no account.
        </p>
