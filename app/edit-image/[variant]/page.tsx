...
export const metadata = {
  title: "Image Editor | Dockitt",
  description: "Browser-based image editing. Coming soon.",
};

export default function EditImageVariantPage() {
  return (
    <main style={{ background: "#f9fafb", minHeight: "60vh" }}>
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "16px", color: "#6b7280", marginBottom: "32px", lineHeight: 1.6 }}>
          This image editing tool is coming soon. In the meantime, try our PDF tools below.
        </p>
