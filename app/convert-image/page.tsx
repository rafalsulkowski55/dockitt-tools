...
export const metadata = {
  title: "Image Converter Online | Dockitt",
  description: "Free browser-based image conversion tools. Coming soon.",
};
    ...
    <main style={{ background: "#f9fafb", minHeight: "60vh" }}>
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "16px", color: "#6b7280", marginBottom: "32px", lineHeight: 1.6 }}>
          Browser-based image conversion tools are on the way. Convert between JPG, PNG, WebP, AVIF and more — no upload, no account.
        </p>
