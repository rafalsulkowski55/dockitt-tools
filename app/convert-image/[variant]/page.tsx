...
export const metadata = {
  title: "Image Converter | Dockitt",
  description: "Browser-based image conversion. Coming soon.",
};

export default function ConvertImageVariantPage() {
  return (
    <main style={{ background: "#f9fafb", minHeight: "60vh" }}>
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "16px", color: "#6b7280", marginBottom: "32px", lineHeight: 1.6 }}>
          This image conversion tool is coming soon. In the meantime, try our PDF tools below.
        </p>
