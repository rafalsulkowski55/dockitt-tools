...
const SLUG_CONFIG: Record<string, SlugConfig> = {
  "svg-to-png":  { mime: "image/png",  whiteBg: false },
  "svg-to-jpg":  { mime: "image/jpeg", whiteBg: true  },
  "svg-to-webp": { mime: "image/webp", whiteBg: false },
};
...
export default function SvgConvertTool({ variant }: Props) {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      const img = await new Promise<HTMLImageElement>((resolve, reject) => {
        ...
        el.onerror = () => reject(new Error("Failed to render SVG. The file may be invalid."));
        el.src = objectUrl;
      });
      ...
      if (cfg.whiteBg) { ctx.fillStyle = "#ffffff"; ctx.fillRect(0, 0, w, h); }
