...
export const toolVariants: ToolVariant[] = [
  // compress-pdf
  {
    ...
    title: 'Compress PDF Online — PDF Compressor',
    description: 'Compress PDF files online . No sign-up, no installation. Reduce PDF size instantly in your browser.',
  ...
  },
  {
    ...
    description: 'Compress PDF files  with no limits. Reduce PDF file size online without losing quality.',
    h1: 'Compress PDF ',
    intro: 'Compress any PDF file  — no subscription, no watermarks, no hidden limits. Just upload, compress, and download.',
  },
  {
    slug: 'reduce-pdf-size',
    toolSlug: 'compress-pdf',
    title: 'Reduce PDF Size Online — PDF Size Reducer',
    description: 'Reduce the size of any PDF file online . Make PDF files smaller for email, upload, or storage.',
  ...
  },
  {
    ...
    description: 'Compress a PDF to send by email. Reduce PDF file size below 10MB or 25MB attachment limits .',
  ...
  // merge-pdf
  {
    ...
    description: 'Merge PDF files online . Combine multiple PDFs into one document instantly, no sign-up required.',
  ...
  },
  {
    ...
    description: 'Merge PDF files  with no limits. Combine PDFs online without watermarks or sign-up.',
    h1: 'Merge PDF Files ',
    intro: 'Combine as many PDF files as you need — , with no watermarks added to your document and no limit on the number of files.',
  },
  {
    slug: 'combine-pdf',
    toolSlug: 'merge-pdf',
    title: 'Combine PDF Files Online — PDF Combiner',
    description: 'Combine multiple PDF files into one online . Fast, easy PDF combining without any software.',
  ...
  },
  {
    slug: 'join-pdf',
    toolSlug: 'merge-pdf',
    title: 'Join PDF Files Online — PDF Joiner',
    description: 'Join multiple PDF files into one document online. PDF joiner with no sign-up required.',
  ...
  // split-pdf
  {
    ...
    toolSlug: 'split-pdf',
    title: 'Split PDF Online — PDF Splitter',
    description: 'Split PDF files online . Extract pages from a PDF and download as a new document instantly.',
    h1: 'Split PDF Online',
  ...
  },
  {
    ...
    description: 'Split PDF files  with no limits. Extract pages from any PDF online without watermarks.',
    h1: 'Split PDF ',
    intro: 'Split any PDF file  — extract the pages you need without any watermarks, sign-up, or usage limits.',
  },
  {
    slug: 'extract-pages-from-pdf',
    toolSlug: 'split-pdf',
    title: 'Extract Pages from PDF Online — Free Tool',
    description: 'Extract specific pages from a PDF file online . Save selected pages as a new PDF document.',
    h1: 'Extract Pages from PDF',
    intro: 'Need just a few pages from a larger document? Extract exactly the pages you need and download them as a new PDF — without any sign-up.',
  },
  // rotate-pdf
  {
    ...
    description: 'Rotate PDF pages online . Fix upside-down or sideways PDF pages instantly without any software.',
  ...
  },
  {
    ...
    description: 'Rotate PDF pages  online. Turn PDF pages 90 or 180 degrees without any sign-up.',
    h1: 'Rotate PDF ',
    intro: 'Rotate the pages in any PDF file . No watermarks, no account required — just upload, choose the rotation angle, and download.',
  },
  {
    slug: 'flip-pdf-pages',
    toolSlug: 'rotate-pdf',
    title: 'Flip PDF Pages Online — Rotate and Fix PDF Orientation',
    description: 'Flip and rotate PDF pages online . Correct page orientation in any PDF without software.',
  ...
  // delete-pdf-pages
  {
    ...
    description: 'Delete pages from a PDF online . Remove unwanted pages from any PDF without software.',
  ...
  },
  {
    ...
    description: 'Remove unwanted pages from a PDF file online . Delete single or multiple pages instantly.',
    h1: 'Remove Pages from PDF',
    intro: 'Whether it\'s a blank page at the end, a cover sheet you don\'t need, or confidential pages that shouldn\'t be shared — remove any pages from your PDF instantly and .',
  },
  {
    slug: 'delete-pages-from-pdf-free',
    toolSlug: 'delete-pdf-pages',
    title: 'Delete Pages from PDF Free — No Sign-Up Required',
    description: 'Delete pages from any PDF . No watermarks, no sign-up — remove PDF pages online instantly.',
    h1: 'Delete Pages from PDF ',
    intro: 'Delete any pages from a PDF file . No account, no watermarks, no limits on the number of pages you can remove.',
  },
  // protect-pdf
  {
    slug: 'protect-pdf-online',
    toolSlug: 'protect-pdf',
    title: 'Password Protect PDF Online — PDF Protection',
    description: 'Add a password to a PDF online . Protect your PDF with 128-bit encryption instantly.',
  ...
  },
  {
    ...
    toolSlug: 'protect-pdf',
    title: 'Add Password to PDF Online — PDF Encryption',
    description: 'Add a password to your PDF file online . Encrypt PDF with 128-bit security without software.',
    h1: 'Add Password to PDF Online',
    intro: 'Secure any PDF with a password in seconds. Upload your file, set a password, and download the encrypted document —  with no account required.',
  },
  {
    slug: 'encrypt-pdf',
    toolSlug: 'protect-pdf',
    title: 'Encrypt PDF Online — PDF Encryption Tool',
    description: 'Encrypt a PDF file online . Add 128-bit password protection to any PDF without software.',
  ...
  // unlock-pdf
  {
    ...
    description: 'Unlock a password-protected PDF online . Remove PDF password instantly without any software.',
  ...
  },
  {
    ...
    description: 'Remove a password from a PDF file online . Unlock protected PDFs without any software.',
  ...
  },
  {
    ...
    description: 'Decrypt and unlock a password-protected PDF online . Remove encryption from PDF files instantly.',
  ...
  // watermark-pdf
  {
    ...
    description: 'Add a text watermark to a PDF online . Watermark PDF files with custom text instantly.',
    h1: 'Add Watermark to PDF Online',
    intro: 'Add a custom text watermark to every page of your PDF — directly in your browser. Mark documents as Draft, Confidential, or add your own text, without sign-up.',
  },
  {
    slug: 'add-watermark-to-pdf',
    toolSlug: 'watermark-pdf',
    title: 'Add Watermark to PDF — Free Online Watermark Tool',
    description: 'Add custom text watermark to PDF files online . No software needed, no sign-up required.',
  ...
  },
  {
    ...
    description: 'Add a text stamp to your PDF pages online . Stamp PDF with DRAFT, CONFIDENTIAL, or any custom text.',
  ...
  // sign-pdf
  {
    ...
    description: 'Sign a PDF online . Draw your signature and embed it into any PDF without printing or software.',
    h1: 'Sign PDF Online',
  ...
  },
  {
    ...
    description: 'Add your handwritten signature to a PDF online . No printing, no scanning, no software needed.',
    h1: 'Add Signature to PDF',
    intro: 'Skip the print-sign-scan workflow. Draw your signature directly on any PDF page and download the signed file in seconds — .',
  },
  {
    slug: 'esign-pdf',
    toolSlug: 'sign-pdf',
    title: 'eSign PDF Online — Electronic Signature for PDF Free',
    description: 'Electronically sign a PDF online . Add an e-signature to any PDF without software or sign-up.',
    h1: 'eSign PDF Online',
  ...
  // crop-pdf
  {
    ...
    description: 'Crop PDF pages online . Remove margins and trim PDF page borders without any software.',
    h1: 'Crop PDF Pages Online',
    intro: 'Trim the margins from any PDF page directly in your browser. Set the crop area, preview the result, and download the cropped PDF — without sign-up.',
  },
  {
    slug: 'trim-pdf-margins',
    toolSlug: 'crop-pdf',
    title: 'Trim PDF Margins Online — Remove PDF White Space Free',
    description: 'Trim and remove margins from PDF pages online . Crop white space and borders from PDF files.',
  ...
  },
  {
    ...
    description: 'Remove margins from PDF pages online . Crop and trim PDF page borders without software.',
  ...
  // repair-pdf
  {
    ...
    description: 'Repair a corrupted or damaged PDF online . Fix PDF files that won\'t open without any software.',
  ...
  },
  {
    ...
    toolSlug: 'repair-pdf',
    title: 'Fix Corrupted PDF Online — PDF Repair Tool',
    description: 'Fix a corrupted or damaged PDF file online . Recover PDFs that fail to open or display errors.',
  ...
  },
  {
    ...
    description: 'Recover and repair a damaged PDF file online . Rebuild corrupted PDF structure without software.',
  ...
  // ocr-pdf
  {
    ...
    description: 'Run OCR on a PDF online . Make scanned PDFs searchable and selectable without any software.',
    h1: 'OCR PDF Online',
  ...
  },
  {
    ...
    description: 'Make a scanned PDF searchable online . Add a text layer to scanned PDFs using OCR technology.',
  ...
  },
  {
    ...
    description: 'Convert a scanned PDF to a searchable PDF online . Add OCR text layer to any scanned document.',
  ...
  // extract-pdf-pages
  {
    ...
    description: 'Extract specific pages from a PDF online . Pick individual pages in any order and save as a new PDF.',
  ...
  },
  {
    ...
    description: 'Extract and save specific pages from a PDF . No sign-up, no watermarks — pick any pages from any PDF.',
    h1: 'Extract PDF Pages ',
    intro: 'Extract any combination of pages from a PDF . No account, no watermarks — just select the pages you need and download.',
  },
  {
    slug: 'save-pdf-pages',
    toolSlug: 'extract-pdf-pages',
    title: 'Save Specific PDF Pages — Extract and Download PDF Pages Free',
    description: 'Save specific pages from a PDF file online . Extract and download individual PDF pages instantly.',
  ...
  // reorder-pdf-pages
  {
    ...
    description: 'Reorder and rearrange PDF pages online . Drag and drop pages into the right order without software.',
  ...
  },
  {
    ...
    description: 'Rearrange pages in a PDF online . Drag and drop PDF pages into any order without any software.',
    h1: 'Rearrange PDF Pages Online',
    intro: 'Got a PDF where the pages are in the wrong order? Drag and drop the page thumbnails into the correct sequence and download the rearranged document — .',
  },
  {
    slug: 'reorganize-pdf',
    toolSlug: 'reorder-pdf-pages',
    title: 'Reorganize PDF Pages Online — PDF Page Organizer',
    description: 'Reorganize and reorder pages in any PDF online . Sort and arrange PDF pages without software.',
