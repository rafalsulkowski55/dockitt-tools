export const watermarkPdfTool = {
  ...
  description: "Add a custom text watermark to your PDF file online — free and without any software.",
  ...
  shortDescription: "Add watermark to PDF files online for free.",
  category: "security",
  type: "process",
